...
// 第二大陸地圖定義 (28格：大海、大地與超古代遺跡之傳奇探索大陸)
export const MAP_LOCATIONS_CHAPTER_2 = [
  { id: 0, name: '啟航冒險起點 (START)', type: 'start', desc: '經過或停留獲得 300 金幣，點燃探索之火！', color: '#ff3d00' },
  { id: 1, name: '綠色大草原 (Steppe)', type: 'grass', terrain: '草原', desc: '無際大地！野生小貓怪與咕妞妞出沒地 (Lv.20+)', color: '#00e676', pokemonIds: [403, 293] },
  { id: 2, name: '荒野友好商店', type: 'mart', desc: '購買回復藥水與高級冒險道具', color: '#00e5ff' },
  { id: 3, name: '創世大裂谷 (Canyon)', type: 'rock', terrain: '裂谷', desc: '板塊運動奇觀！野生大岩蛇與卡拉卡拉出沒地 (Lv.22+)', color: '#ffd700', pokemonIds: [95, 104] },
  { id: 4, name: '烈陽屬性石礦場 (Mine)', type: 'stoneMine', desc: '⛏️ 停留可花費 50 G 進行採礦，有機率挖到火/雷/水之石', color: '#ff9100' },
  { id: 5, name: '蔚藍海溝 (Trench)', type: 'water', terrain: '海洋', desc: '深邃海洋！野生波加曼與咬咬龜出沒地 (Lv.20+)', color: '#00b0ff', pokemonIds: [393, 833] },
  { id: 6, name: '隨機冒險事件', type: 'event', desc: '大海與大地的古老命運考驗', color: '#e91e63' },
  { id: 7, name: '熔岩煉獄火山 (Volcano)', type: 'cave', terrain: '火山', desc: '暴虐火山！野生超音蝠與綠毛蟲出沒地 (Lv.24+)', color: '#ff3d00', pokemonIds: [41, 10] },
  { id: 8, name: '大地寶可夢培育屋 (Daycare)', type: 'daycare', desc: '🏠 停留可寄存夥伴，在背景吸收無垠大地的經驗值！', color: '#ffc107' },
  { id: 9, name: '雷暴高地 (Highlands)', type: 'grass', terrain: '高地', desc: '雷雨交加！野生小貓怪與皮卡丘出沒地 (Lv.25+)', color: '#00e676', pokemonIds: [403, 25] },
  { id: 10, name: '荒野友好商店', type: 'mart', desc: '購買回復藥水與高級冒險道具', color: '#00e5ff' },
  { id: 11, name: '鋼鐵巨岩峰 (Iron Peak)', type: 'rock', terrain: '巨岩', desc: '矗立於荒野！準神鐵啞鈴與隆隆石出沒地 (Lv.26+)', color: '#ffd700', pokemonIds: [374, 75] },
  { id: 12, name: '訓練師武道館 (Dojo)', type: 'dojo', desc: '🥋 挑戰駐防傳奇館主(赤紅/竹蘭/大吾/阿渡/武藏)，贏取巨額獎金與屬性石！', color: '#ff9800' },
  { id: 13, name: '神奧港口 (Port)', type: 'port', desc: '⚓ 可免費搭乘聖特安努號返回關都枯葉市港口', color: '#00e5ff' },
  { id: 14, name: '隨機冒險事件', type: 'event', desc: '大海與大地的古老命運考驗', color: '#e91e63' },
  { id: 15, name: '超古代神廟 (Temple)', type: 'cave', terrain: '遺跡', desc: '埋藏創世神話！野生單卵細胞球與耿鬼出沒地 (Lv.28+)', color: '#d500f9', pokemonIds: [577, 94] },
  { id: 16, name: '神奧寶可夢中心', type: 'center', desc: '大地泉水！免費回復所有寶可夢的體力', color: '#ff1744' },
  { id: 17, name: '翡翠森林迷宮 (Maze)', type: 'grass', terrain: '森林', desc: '迷霧森林！野生寶寶丁與妙蛙草出沒地 (Lv.28+)', color: '#00e676', pokemonIds: [174, 2] },
  { id: 18, name: '荒野友好商店', type: 'mart', desc: '購買回復藥水與高級冒險道具', color: '#00e5ff' },
  { id: 19, name: '天冠山麓裂谷 (Valley)', type: 'rock', terrain: '山麓', desc: '通往神話之巔！野生龜腳腳與大岩蛇出沒地 (Lv.30+)', color: '#ffd700', pokemonIds: [688, 95] },
  { id: 20, name: '烈陽屬性石礦場 (Mine)', type: 'stoneMine', desc: '⛏️ 停留可花費 50 G 進行採礦，有機率挖到火/雷/水之石', color: '#ff9100' },
  { id: 21, name: '亞特蘭提斯神殿 (Atlantis)', type: 'water', terrain: '神話海域', desc: '失落的海底神殿！史詩級拉普拉斯與鯉魚王出沒地 (Lv.32+)', color: '#00b0ff', pokemonIds: [131, 129] },
  { id: 22, name: '隨機冒險事件', type: 'event', desc: '大海與大地的古老命運考驗', color: '#e91e63' },
  { id: 23, name: '帕底亞無底深淵 (Abyss)', type: 'cave', terrain: '深淵', desc: '吞噬光線！野生科斯莫古與袋獸出沒地 (Lv.35+)', color: '#d500f9', pokemonIds: [789, 115] },
  { id: 24, name: '神奧寶可夢中心', type: 'center', desc: '大地泉水！免費回復所有寶可夢的體力', color: '#ff1744' },
  { id: 25, name: '黃金小麥大地 (Wheat Field)', type: 'grass', terrain: '大地', desc: '風吹麥浪！野生蛋蛋與伊布出沒地 (Lv.30+)', color: '#00e676', pokemonIds: [102, 133] },
  { id: 26, name: '隨機冒險事件', type: 'event', desc: '大海與大地的古老命運考驗', color: '#e91e63' },
  { id: 27, name: '太晶零之秘境 (Zero Crater)', type: 'cave', terrain: '秘境', desc: '終極太晶化！古神密勒頓、故勒頓與無極汰那甦醒地 (Lv.45+)', color: '#d500f9', pokemonIds: [1008, 1007, 890] }
];
